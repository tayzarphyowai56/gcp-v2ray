...
LOG_FILE="/tmp/1011_vless_$(date +%s).log"
touch "$LOG_FILE"
on_err() {
  local rc=$?
  echo "" | tee -a "$LOG_FILE"
...
PROTO="vless-ws"
# IMPORTANT: You must build and push this image or use a public one.
# Replaced nkka404 with zero1011. If you haven't built this yet, the script will fail at Step 9.
